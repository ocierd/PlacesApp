...
import com.places.api.services.interfaces.SucursalService;
...
public class SucursalController extends BaseController {
    ...
    @PutMapping("/{sucursal_id}/tipo-pago/{tipo_pago_id}")
    public Sucursal crearTipoPago(@PathVariable("sucursal_id") Long sucursalId,
            @PathVariable("tipo_pago_id") Short tipoPagoId) throws NoEncontradoException {
        return sucursalService.agregarTipoPago(sucursalId, tipoPagoId);
    }
