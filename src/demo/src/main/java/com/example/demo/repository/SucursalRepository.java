...
public interface SucursalRepository extends JpaRepository<Sucursal, Long> {
    ...
    /**
     * Crea una nueva sucursal en la base de datos utilizando un procedimiento almacenado. Recibe los parámetros necesarios para crear la sucursal y devuelve el ID de la sucursal creada.
     * @param empresaId El ID de la empresa a la que pertenece la sucursal
     * @param nombreSucursal El nombre de la sucursal a crear
     * @param ubicacionId El ID de la ubicación asociada a la sucursal (puede ser null)
     * @param latitud La latitud de la ubicación de la sucursal (puede ser null)
     * @param longitud La longitud de la ubicación de la sucursal (puede ser null)
     * @param enlaceMaps El enlace de Google Maps para la ubicación de la sucursal (puede ser null)
